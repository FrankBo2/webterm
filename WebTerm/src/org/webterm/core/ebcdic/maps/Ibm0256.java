...
/**
 * Class for IBM 0256 code
 * 
 * @author charles
 */
public final class Ibm0256 implements ICharMap {

	/** Unique instance. */
	private static final Ibm0256 instance = new Ibm0256();
	 ...
	 */
	public static Ibm0256 getInstance() {
		return instance;
	}
	...
	/** IBM server code */
	private static final int SERVER_CODE = 256;
