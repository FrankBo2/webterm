...
/**
 * Class for IBM 0500 code
 * 
 * @author charles
 */
public final class Ibm0500 implements ICharMap {

	/** Unique instance. */
	private static final Ibm0500 instance = new Ibm0500();
	 ...
	 */
	public static Ibm0500 getInstance() {
		return instance;
	}
