...
/**
 * Class for IBM 0284 code
 * 
 * @author charles
 */
public final class Ibm0284 implements ICharMap {

	/** Unique instance. */
	private static final Ibm0284 instance = new Ibm0284();
	 ...
	 */
	public static Ibm0284 getInstance() {
		return instance;
	}
	...
	/** IBM server code */
	private static final int SERVER_CODE = 284;
