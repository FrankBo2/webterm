...
/**
 * Class for IBM 0285 code
 * 
 * @author charles
 */
public final class Ibm0285 implements ICharMap {

	/** Unique instance. */
	private static final Ibm0285 instance = new Ibm0285();
	 ...
	 */
	public static Ibm0285 getInstance() {
		return instance;
	}
	...
	/** IBM server code */
	private static final int SERVER_CODE = 285;
