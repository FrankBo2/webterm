...
/**
 * Class for IBM 0273 code
 * 
 * @author charles
 */
public final class Ibm0273 implements ICharMap {

	/** Unique instance. */
	private static final Ibm0273 instance = new Ibm0273();
	 ...
	 */
	public static Ibm0273 getInstance() {
		return instance;
	}
	...
	/** IBM server code */
	private static final int SERVER_CODE = 273;
