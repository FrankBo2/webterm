...
/**
 * Class for IBM 0277 code
 * 
 * @author charles
 */
public final class Ibm0277 implements ICharMap {

	/** Unique instance. */
	private static final Ibm0277 instance = new Ibm0277();
	 ...
	 */
	public static Ibm0277 getInstance() {
		return instance;
	}
	...
	/** IBM server code */
	private static final int SERVER_CODE = 277;
