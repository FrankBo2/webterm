...
/**
 * Class for IBM 0037 code
 * 
 * @author charles
 */
public final class Ibm0037 implements ICharMap {

	/** Unique instance. */
	private static final Ibm0037 instance = new Ibm0037();
	 ...
	 */
	public static Ibm0037 getInstance() {
		return instance;
	}
	...
	/** IBM server code */
	private static final int SERVER_CODE = 37;

	/** client code */
	private static final String CLIENT_CODE = "ISO8859-1"; //$NON-NLS-1$

	/** encoder */
	private static final char[] ENCODER = new char[] { 0, 1, 2, 3, 55, 45, 46, 47, /* 0 - 7 */
